...
def prepare_arrays_match():
    ...
    best_s00 = dict()
    best_s01 = dict()
    best_hotels_od_ulc_withmonth = dict()
    total = 0
    ...
    while 1:
        ...
        if user_location_city != '' and orig_destination_distance != '' and book_month !='':
            bxx = (user_location_city, orig_destination_distance, book_month)

            if bxx in best_hotels_od_ulc_withmonth:
                if hotel_cluster in best_hotels_od_ulc_withmonth[bxx]:
                    best_hotels_od_ulc_withmonth[bxx][hotel_cluster] += append_0
                else:
                    best_hotels_od_ulc_withmonth[bxx][hotel_cluster] = append_0
            else:
                best_hotels_od_ulc_withmonth[bxx] = dict()
                best_hotels_od_ulc_withmonth[bxx][hotel_cluster] = append_0
    ...
    f.close()
    return best_s00,best_s01, best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster, best_hotels_od_ulc_withmonth


def gen_submission(best_s00, best_s01,best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster, best_hotels_od_ulc_withmonth):
    ...
    while 1:
        ...
        bxx = (user_location_city, orig_destination_distance,book_month)
        if bxx in best_hotels_od_ulc_withmonth:
            d = best_hotels_od_ulc_withmonth[bxx]
...
best_s00,best_s01,best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster , best_hotels_od_ulc_withmonth = prepare_arrays_match()
gen_submission(best_s00, best_s01,best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster, best_hotels_od_ulc_withmonth)